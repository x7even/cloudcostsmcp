...
**Runs:** gemma-4-26b-a4b 2026-04-23 02:28 UTC · qwen3.6-35b-a3b 2026-04-23 03:30 UTC  
...
| qwen/qwen3.6-35b-a3b | 121 | 2 | 98.4% |
...
| AS9 | AWS Simple | ✅ (4r) | ❌ `max rounds (30) exhausted` |
...
| GC3 | GCP Cloud Armor | ✅ (3r) | ❌ `max_tokens at round 2` |
...
- **qwen3.6-35b-a3b** (`qwen/qwen3.6-35b-a3b`): 121 passed, 2 failed — AS9 agent loop, GC3 max_tokens
