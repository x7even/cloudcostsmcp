...
| v0.8.0 — Tool consolidation + provider protocol | [roadmap_0_8_0.md](roadmap_0_8_0.md) | **done** — 31 tools → 15 tools, unified `get_price(spec)`, `describe_catalog`, discriminated-union `PricingSpec` |
